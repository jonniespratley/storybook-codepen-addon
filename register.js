...
/**
 * Taken from https://github.com/jonniespratley/lucid/blob/master/.storybook/lucid-docs-addon/register.js
 */
addons.register('codepen-docs', api => {
	api.setOptions({
		name: 'Lucid UI',
		url: 'https://github.com/jonniespratley/lucid',
